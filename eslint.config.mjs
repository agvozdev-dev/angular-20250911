...
export default defineConfig([
  ...
  // Общие правила для JS/TS файлов (кроме *.html, *.json*)
  {
    ...
    rules: {
      ...
      'vars-on-top': 'warn',
      'no-var': 'warn',
      camelcase: ['warn', { allow: ['^UNSAFE_'], ignoreDestructuring: false, properties: 'never' }],
  ...
  // @ts-ignore
  {
    ...
    rules: {
      ...
      'no-useless-rename': ['error', { ignoreDestructuring: true, ignoreImport: false, ignoreExport: false }],
      eqeqeq: ['error', 'always'],
      ...
      '@typescript-eslint/naming-convention': [
        'error',
        { selector: 'default', format: ['camelCase', 'PascalCase'], leadingUnderscore: 'allow', trailingUnderscore: 'allow' },
      ...
      '@typescript-eslint/member-ordering': [
        'error',
        {
          default: [
            ...
            'private-decorated-field', 'private-instance-field',
            'protected-decorated-field', 'protected-instance-field',
